...
The redesign preview was built with `dotnet build TennisWatch.csproj -c Debug -t:SignAndroidPackage` and installed in a Wear OS 5 emulator with a round 450 × 450 display at 320 dpi. The screenshots use controlled match data and come directly from that installed APK.
